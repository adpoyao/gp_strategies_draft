...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__components_ResultItemSmall__ = __webpack_require__("./components/ResultItemSmall.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__components_SearchSecondary__ = __webpack_require__("./components/SearchSecondary.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__components_ProductThumbnail__ = __webpack_require__("./components/ProductThumbnail.js");
...
var SearchResults = function (_Component) {
  ...
  function SearchResults() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SearchResults.__proto__ || Object.getPrototypeOf(SearchResults)).call.apply(_ref, [this].concat(args))), _this), _this.filterStatus = function (input, data) {
      if (input !== undefined) {
        input ? _this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["b" /* addStatusFilter */](data)) : _this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["f" /* removeStatusFilter */](data));
      };
    }, _this.filterContentType = function (input, data) {
      if (input !== undefined) {
        input ? _this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["a" /* addContentTypeFilter */](data)) : _this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["e" /* removeContentTypeFilter */](data));
      };
    }, _this.filterTopic = function (input, data) {
      if (input !== undefined) {
        input ? _this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["c" /* addTopicFilter */](data)) : _this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["g" /* removeTopicFilter */](data));
      };
    }, _this.toggleFavoritedSearch = function (input) {
      if (!!input) {
        _this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["i" /* toggleSavedSearch */](input));
      };
  ...
  _createClass(SearchResults, [{
    ...
    value: function componentWillUnmount() {
      this.props.dispatch(__WEBPACK_IMPORTED_MODULE_15__actions_search__["d" /* clearFilters */]());
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var filters = sampleData.map(function (data, index) {
        return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__components_Filter__["a" /* default */], _extends({ key: __WEBPACK_IMPORTED_MODULE_4_shortid___default.a.generate() }, data, {
          __source: {
      ...
      if (products) {
        productThumbnails = products.map(function (product) {
          ...
          return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_13__components_ProductThumbnail__["a" /* default */], _extends({ handleClick: _this2.handleThumbnailClick }, product, {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 116
              }
      ...
      if (contents) {
        resultItems = contents.map(function (content) {
          return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__components_ResultItemSmall__["a" /* default */], _extends({ key: content.id, handleClick: _this2.handleResultClick }, content, {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 140
              }
      ...
      return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_12__components_SearchSecondary__["a" /* default */], {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 196
            }
...
//# sourceMappingURL=5.ec2e6e60e52d14b4d046.hot-update.js.map