...
"use strict";
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return updateSearchTerm; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return toggleSavedSearch; });
/* unused harmony export toggleShowFavorites */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return toggleFilter; });
...
var Filter = function (_Component) {
  ...
  function Filter() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Filter.__proto__ || Object.getPrototypeOf(Filter)).call.apply(_ref, [this].concat(args))), _this), _this.handleClick = function (id) {
      ...
      _this.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_5__actions_search__["a" /* toggleFilter */])(id));
  ...
  _createClass(Filter, [{
    ...
    value: function componentWillUnmount() {
      this.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_5__actions_search__["a" /* toggleFilter */])(undefined));
    }
  }, {
    key: 'render',
...
// import { addStatusFilter, addContentTypeFilter, addTopicFilter, removeContentTypeFilter, removeTopicFilter, removeStatusFilter, toggleSavedSearch, clearFilters } from '../actions/search';
...
var SearchResults = function (_Component) {
  ...
  function SearchResults(props) {
    ...
    _this.filterStatus = function (input, data) {
      if (input !== undefined) {
        input ? _this.props.dispatch(addStatusFilter(data)) : _this.props.dispatch(removeStatusFilter(data));
      };
    };

    _this.filterContentType = function (input, data) {
      if (input !== undefined) {
        input ? _this.props.dispatch(addContentTypeFilter(data)) : _this.props.dispatch(removeContentTypeFilter(data));
      };
    };

    _this.filterTopic = function (input, data) {
      if (input !== undefined) {
        input ? _this.props.dispatch(addTopicFilter(data)) : _this.props.dispatch(removeTopicFilter(data));
      };
    };

    _this.toggleFavoritedSearch = function (input) {
      if (!!input) {
        _this.props.dispatch(toggleSavedSearch(input));
      };
    };
      ...
      if (products) {
        productThumbnails = products.map(function (product) {
          ...
          return __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(
            ...
            __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_11__components_ProductThumbnail__["a" /* default */], _extends({ handleClick: _this2.handleThumbnailClick }, product, {
              __source: {
                fileName: _jsxFileName,
                lineNumber: 123
              }
...
//# sourceMappingURL=5.a3e926aec536be57aed2.hot-update.js.map