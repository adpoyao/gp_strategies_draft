  ...
  _createClass(ResultItemLarge, [{
    ...
    value: function render() {
      ...
      if (this.props.isFavorited) {
        ...
        goldStarSmall = __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('img', { className: 'favorite-star-sm star-icon', src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Gold_Star.svg/2000px-Gold_Star.svg.png', style: 'max-width: 32px', __source: {
            fileName: _jsxFileName,
            lineNumber: 10
          }
        });
        goldStarLarge = __WEBPACK_IMPORTED_MODULE_1_react___default.a.createElement('img', { className: 'favorite-star-sm star-icon', src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/2/29/Gold_Star.svg/2000px-Gold_Star.svg.png', style: 'max-width: 32px', __source: {
            fileName: _jsxFileName,
            lineNumber: 11
          }
        });
...
//# sourceMappingURL=5.24487f41e2e0656e270b.hot-update.js.map