    ...
    value: function render() {
      ...
      if (!this.props.searchTerm.length) {
        ...
        if (this.state.findWidth) {
          customInputWidth = this.state.findWidth() + 'ch';
        };
...
//# sourceMappingURL=5.75d335594fe5e28fbc46.hot-update.js.map