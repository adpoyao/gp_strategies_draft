...
var SearchPrimary = function (_Component) {
  ...
  function SearchPrimary(props) {
    ...
    _this.onSavedSearchClick = function () {
      _this.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_8__actions_search__["b" /* toggleSavedSearch */])(!_this.props.savedSearch));
    };
  ...
  _createClass(SearchPrimary, [{
    ...
    value: function onHandleInputChange(event) {
      ...
      event.persist();
      this.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_8__actions_search__["c" /* updateSearchTerm */])(event.target.value));
      this.props.dispatch(Object(__WEBPACK_IMPORTED_MODULE_8__actions_search__["b" /* toggleSavedSearch */])(false));
...
//# sourceMappingURL=4.a3e926aec536be57aed2.hot-update.js.map